...
const controller = {
    ...
    getDashboardStadistics: (req, res) =>{
       //Para esta llamada voy a necesitar que devuelva:
        ...
        // Cantidad total del monto de los productos
            ...
            .then(function(users){
                ...
                .then((recetas) => {
                    ...
                    let jsonResult = {
                        ...
                        result: [
                            {
                                title: 'Total Productos Cargados',
    ...
    getPurcharseRecipe : (req, res) => {
        ...
        .then((result) => {
            ...
            let jsonResult = {
                meta: {
                    status: 200,
                    desc: 'Esta API devuelve la cantidad de ventas y el monto vendido',
                    count: resultado.length,
                    url: 'api/dashboard/getPurcharseByProducts'          
                },
                result: resultado
            }
            return res.send(jsonResult);
